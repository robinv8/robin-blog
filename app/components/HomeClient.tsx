...
const SECTIONS = [
  { no: '01', href: '/weekly', zh: '周刊', en: 'WEEKLY', descZh: '每周记录与分享', descEn: 'Weekly notes & shares' },
  { no: '02', href: '/photography', zh: '摄影', en: 'PHOTOGRAPHY', descZh: '光影与瞬间', descEn: 'Light & moments' },
  { no: '03', href: '/projects', zh: '项目', en: 'WORKS', descZh: '做点儿有趣的东西', descEn: 'Building fun things' },
  { no: '04', href: '/books', zh: '书架', en: 'BOOKSHELF', descZh: '读过的与在读的', descEn: 'Read & reading' },
  { no: '05', href: '/friends', zh: '友链', en: 'LINKS', descZh: '朋友们的站点', descEn: 'Friends of the site' },
  { no: '06', href: '/about', zh: '关于', en: 'ABOUT', descZh: '认识一下我', descEn: 'Get to know me' },
];
