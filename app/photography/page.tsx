            ...
            <div className="glass-card p-1.5 rounded-2xl overflow-hidden transition-all duration-500 group-hover:shadow-2xl">
              <div className="relative overflow-hidden rounded-xl">
                <img
                  alt="Silent Forest"
                  className="w-full h-auto object-cover transform transition-transform duration-700 group-hover:scale-110"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuCDtAsY0ysOp2wsk6APYgPGn0a7wnrNcTH6U5CX0u-J6YEgcF-cdADUtGVCckeDULm1ulLHButIp49kv0BhGLZNKWviPgX92_8LCBX_8neJzEFq2ErapC4DPMqTbUZqu69MSF18octf4y5cd6FV9kBg09csDS_AZN86akf5p3Q85hNdSl0s_H6yvm6g_c9ethCkG_d6Y_JE7AoH8BBkmDaNyYpFZBaLGOMq9E4kB79lt764nvY6U4Uu7YotebXQI9s9SgfConCfYws"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-5">
                  <h3 className="text-white font-medium text-lg translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                    Silent Forest
            ...
            <div className="glass-card p-1.5 rounded-2xl overflow-hidden transition-all duration-500 group-hover:shadow-2xl">
              <div className="relative overflow-hidden rounded-xl">
                <img
                  alt="Green Silence"
                  className="w-full h-auto object-cover transform transition-transform duration-700 group-hover:scale-110"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuAqSFNWABhxK01GV-msIQIWkWaAunGsA_J1L4gyXTpX8IjFl8rT0VMy7_42ZVVnxdTVfesCXFT3XGVkU0BMHMirRuwVHrjDtxBZR2KXJhIg6gVVZ1IoIxFjBExe8h8TudfvWhJ3iF85m1aTZbjfniVU8ft_2ik8HVROTS5FlB6pFbwd6a2NsbUAJOadO_F8WbpeYxPp29U4XONhKjB2xbjxTDjcmSrD-o0-t3slpZ0mEKIIQNL8z7pR3pcU39yRYZZNWz3dXYTE274"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-5">
                  <h3 className="text-white font-medium text-lg translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                    Green Silence
            ...
            <div className="glass-card p-1.5 rounded-2xl overflow-hidden transition-all duration-500 group-hover:shadow-2xl">
              <div className="relative overflow-hidden rounded-xl">
                <img
                  alt="Daily Ritual"
                  className="w-full h-auto object-cover transform transition-transform duration-700 group-hover:scale-110"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuAesDQMs4EqBn9_4RVTxPAse5Sb1lpBtGBW5q8Hi21bEB4JNBETiyWmz6Pjs-F49lKwof9z93_YTW5FoXWNYVrW3RaeCl-0_x_BpxHgUo1BXqzZiemV4ZBv84QfJ_UxGASoJxIAFP90jMmeJLrEyedyyUU3NW1OhMpg6vmSXFVkiR6j_aXfynoEySe-FqcwYgelWZM46B4yFiYaW_BCWEaZFAi345fxYRugMhmosUoat_lEBKusn1qp8fM6CATnOZhdVg9jjEVChSA"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-5">
                  <h3 className="text-white font-medium text-lg translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                    Daily Ritual
            ...
            <div className="glass-card p-1.5 rounded-2xl overflow-hidden transition-all duration-500 group-hover:shadow-2xl">
              <div className="relative overflow-hidden rounded-xl">
                <img
                  alt="Golden Hour"
                  className="w-full h-auto object-cover transform transition-transform duration-700 group-hover:scale-110"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuD_YIM1xVb9r6HOaUU2HXYVvph-9TV7KyIHJLO3z3EyOMpCltMwEEoFVWRr0wdEImkFNUBkQLzCk1SFih_bIicLt4ohMDCYZxq-upEK1WEuxTr-mHodbYWgn4ahbB7G_XK1mESJp0sC6lTQYYc1Sv2E76cryhbZ5WkwuBiOFWdB2KjU_8yLQGt1ScGDDiO5bQMCHS1fDWqXmwFl8dLI90mmOLUUwYg06XQDH7_DO5Ks4YC_jNDk-YD7AnZ-QdMKT4_hJ6Ew0HLlnok"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-5">
                  <h3 className="text-white font-medium text-lg translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                    Golden Hour
            ...
            <div className="glass-card p-1.5 rounded-2xl overflow-hidden transition-all duration-500 group-hover:shadow-2xl">
              <div className="relative overflow-hidden rounded-xl">
                <img
                  alt="Night Out"
                  className="w-full h-auto object-cover transform transition-transform duration-700 group-hover:scale-110"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuDTRO4BR9mo_lbRguG9-Jx-fiPnfkPUKTIE_HrPHEO2Ial3BtXq3PO897X4qqXKm9BdslRrKxmehDaFNcQ_5my6VXNZpQN1ySkWkha7fXavfW3jObEt0C5Hl5KtiutWrgacdQHuKFr8XEJcgP_cfnzgA9usIL1531vHEiI2ehPOsgvjmHFZ5H0NrqRk79_qWE2Ekih9V0zAGDPuXS_JjTCp6ykv0Ni4vPerE2AO3vyOH-tFTWG-6s-oRPscaHOxNNdQk9fzeL5qHRk"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-5">
                  <h3 className="text-white font-medium text-lg translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                    Night Out
